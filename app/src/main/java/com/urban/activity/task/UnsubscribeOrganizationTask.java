...
public class UnsubscribeOrganizationTask extends AsyncTask<Object, Void, String> {
    ...
    public UnsubscribeOrganizationTask(OrganizationAdapter adapter, User user, View view, Organization organization) {
        super();
    ...
    protected String doInBackground(Object... params) {
        try {
            UrbanServiceFactory.getInstance().unsubscribe(user, organization);
