...
public class SubscribePositionTask extends AsyncTask<Object, Void, String> {
    ...
    public SubscribePositionTask(PositionAdapter adapter, User user, View view, Position position) {
        super();
    ...
    protected String doInBackground(Object... params) {
        try {
            UrbanServiceFactory.getInstance().subscribe(user, position);
