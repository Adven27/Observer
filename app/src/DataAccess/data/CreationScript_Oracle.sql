...
CREATE TABLE "User" (id number(10) NOT NULL, login varchar2(255) NOT NULL UNIQUE, password varchar2(255) NOT NULL, regDate date NOT NULL, isBlocked number(10), person number(10) NOT NULL, IMEI number(20) NOT NULL, PRIMARY KEY (id));
