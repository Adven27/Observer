...
CREATE TABLE "User" (id  INTEGER NOT NULL, login varchar(255) NOT NULL UNIQUE, password varchar(255) NOT NULL, regDate date NOT NULL, isBlocked integer(10), person integer(10) NOT NULL, IMEI integer(20) NOT NULL, PRIMARY KEY (id), FOREIGN KEY(person) REFERENCES Person(id));
