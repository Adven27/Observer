...
public class OrganizationStubGen {
    ...
    public static void main(String args[]) {
        ...
        for (OrganizationStub org : orgs) {
            ...
            System.out.printf(
                    "insert into addresses (\"id\", \"street\", \"house\", \"letter\", \"floor\", \"office\") "
                    + "values ('%s', '%s', '%s', '%s', '%s', '%s');%n", i, org.place.address.street, org.place.address.house, org.place.address.letter, org.place.address.floor, org.place.address.flat);
